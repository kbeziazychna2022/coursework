...
def get():
    ...
    C2 = ormCountry(name="Spain",population=30234567,goverment='Goverment5',location='22.00.55,98.45.67', client_documents='HE231456')
    C3 = ormCountry(name="Ukraine",population=764321,goverment='Goverment6',location='23.34.55,76.45.67', client_documents='HE239018')
